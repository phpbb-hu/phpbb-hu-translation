...
$lang = array_merge($lang, array(
	...
	'AJAX_ERROR_TEXT_TIMEOUT'		=> 'A kérése idő túllépés miatt megszakadt; kérjük próbálja újra.',
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> 'Ez a külső szolgáltatás már hozzá lett rendelve egy másik fórum azonosítóhoz.', //? This external service is already associated with another board account.
	...
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'						=> 'A külső szolgáltatás hibás értéket adott vissza, emiatt a kérését nem sikerült feldolgozni.', //? The external service returned a wrong value therefore your request can not be processed.
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'Egy PHP kiegészítés megállította a feltöltést.',
	...
	'CONFIRM_AVATAR_DELETE' => 'Biztosan törölni szeretné ezt az avatart?',
	...
	'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'	=> 'Nem sikerült módosítani fájl tulajdonos csoportját',
	'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'	=> 'Nem sikerült módosítani fájl jogosultságait',
	'FILESYSTEM_CANNOT_COPY_FILES'		=> 'Nem sikerült a fájlok másolása',
	'FILESYSTEM_CANNOT_CREATE_SYMLINK'	=> 'Nem sikerült szimbolikus linket létrehozni',
	'FILESYSTEM_CANNOT_CREATE_DIRECTORY'	=> 'Nem sikerült könyvtárat létrehozni',
	'FILESYSTEM_CANNOT_DELETE_FILES'	=> 'Nem sikerült a fájlok törlése',
	'FILESYSTEM_CANNOT_DUMP_FILE'		=> 'Nem sikerült a fájl kiírása',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'	=> 'Nem sikerült a könyvtár tükrözése',
	'FILESYSTEM_CANNOT_RENAME_FILE'	=> 'Nem sikerült a fájl átnevezése',
	'FILESYSTEM_CANNOT_TOUCH_FILES'	=> 'Nem sikerült meghatározni, hogy a fájl létezik-e',
	...
	'JUMP_TO_PAGE_CLICK'	=> 'Kattintson a megadott oldalra ugráshoz…',
	...
	'LOGIN_ERROR_ATTEMPTS'				=> 'Túllépte az engedélyezett belépési kísérletek számát. Ezért a felhasználóneve és a jelszava megadása mellett most meg kell oldania az alább látható CAPTCHA tesztet is.',
	...
	'LOGIN_REQUIRED'					=> 'Ehhez a művelethez be kell jelentkeznie.',
	'LOGOUT'							=> 'Kilépés',
	'LOGOUT_USER'						=> 'Kilépés [ %s ]',
	'LOG_ME_IN'							=> 'Emlékezzen rám',
	...
	'NEVER'						=> 'Soha',
	'NO'						=> 'Nem',
	'NO_NOTIFICATIONS'			=> 'Nincs értesítése',
	...
	'NOTIFICATION_GROUP_REQUEST_APPROVED'	=> '<strong>Kérelem elfogadása</strong>, hogy csatlakozhasson a %1$s csoporthoz.', //?
	...
	'NO_STYLE_DATA'				=> 'Nem sikerült lekérni a %s megjelenés adatait és beállítani azt a %s felhasználói azonosítóhoz', //? Could not get style data for user_style %s and set for user_id %s
	'NO_STYLE_CFG'				=> 'Nem érhető el a megjelenés beállítás fájlja a következőhöz: %s',
...
// "... and 2 hidden users online"
	...
	'SORRY_AUTH_READ_TOPIC'		=> 'Nincs jogosultsága a téma megtekintéséhez',
	...
	'UNABLE_GET_IMAGE_SIZE'	=> 'Nem sikerült meghatározni a kép méretét. Kérjük ellenőrizze, hogy a megadott URL érvényes-e.',
